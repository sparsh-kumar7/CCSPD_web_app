...
const SolutionPage = ({ question, questionNumber }) => (
    <div className="SolutionPage">
        ...
        <button className={`qbu qbutton ${question.answer === "optionA" ? "correct" : "wrong"}`}>
            {question.optionA} {question.answer === "optionA"}
        </button>
        <button className={`qbu qbutton ${question.answer === "optionB" ? "correct" : "wrong"}`}>
            {question.optionB} {question.answer === "optionB"}
        </button>
        <button className={`qbu qbutton ${question.answer === "optionC" ? "correct" : "wrong"}`}>
            {question.optionC} {question.answer === "optionC"}
        </button>
        <button className={`qbu qbutton ${question.answer === "optionD" ? "correct" : "wrong"}`}>
